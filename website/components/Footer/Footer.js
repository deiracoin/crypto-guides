      ...
      <Container>
        <div className="Footer-top">
          <div className="Footer-nav">
            ...
            <a className="Footer-nav-item" target="_blank" rel="noopener noreferrer" href="https://deiracoin.com">About</a>
            <a className="Footer-nav-item" target="_blank" rel="noopener noreferrer" href="https://t.me/deiracoin">Contact</a>
            <a className="Footer-nav-item" target="_blank" rel="noopener noreferrer" href="http://deiracoin.com/">dEiRA Wallet</a>
        ...
        <div className="Footer-bottom">
          <a href="https://deiracoin.com" target="_blank" rel="noopener noreferrer" >
            <Logo className="Logo" />
