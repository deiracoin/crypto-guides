...
For instance, when creating the wallet on [dEiRA wallet](https://deiracoin.com) the user gets a single private key for all cryptocurrencies supported by a wallet.
